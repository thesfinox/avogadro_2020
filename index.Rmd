...
<h3>Solution</h3>
<ul>
<li>$\dim_{\mathbb{C}} M = m$</li>
<li>$\mathrm{Hol}(g) \subseteq \mathrm{SU}(m)$</li>
...
<ul>
<li>$W$ are controlled and tuned</li>
...
<div class="column-2">
<div class="centered">
[![](https://imgs.xkcd.com/comics/machine_learning.png){width=75%}](https://xkcd.com/1838/)
</div>
</div>
</div>
...
<li>**backpropagation** $\rightarrow$ $W^{\{l\}} = \left( w^{\{l\}}, b^{\{l\}} \right)$</li>
</div>
</div>
...
<div class="cite">https://playground.tensorflow.org</div>
