...
date: "<b>XVI Avogadro Meeting</b> - December 15th, 2020"
output:
...
<script>
  $(document).ready(function() {
    $('slide:not(.title-slide, .backdrop, .segue)').append('<footer label=\"Riccardo Finotello - Inception NN for CICY - 15/12/2020 - XVI Avogadro Meeting\"></footer>');
    })
</script>
